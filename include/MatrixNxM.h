...
protected:
	...
	void FindPivotElem(int nDiag, int *pBestRow, int *pBestCol);
...
{															
	...
	IppStatus stat = ippmInvert_m_32f(&(*this)[0][0],
		...
		GetRows(), 											
		arrBuffer,											
		pElements, GetRows() * sizeof(float));
...
{															
	...
	IppStatus stat = ippmInvert_m_64f(&(*this)[0][0],
		...
		GetRows(), 											
		arrBuffer,											
		pElements, GetRows() * sizeof(double));
...
//////////////////////////////////////////////////////////////////////
template<class TYPE>
bool CMatrixNxM<TYPE>::Invert(bool bFullPivot)
{
	// only invert square matrices
	ASSERT(GetCols() == GetRows());

	// Gauss-Jordan elimination
	CMatrixNxM<TYPE> mCopy(*this);		// the copy of this matrix
	CMatrixNxM<TYPE> mInv(*this);		// stores the built inverse
	mInv.SetIdentity();
...
//////////////////////////////////////////////////////////////////////
// CMatrixNxM<TYPE>::InterchangeRows
//
// swaps two rows of the matrix
//////////////////////////////////////////////////////////////////////
template<class TYPE>
void CMatrixNxM<TYPE>::InterchangeRows(int nRow1, int nRow2)
{
...
//////////////////////////////////////////////////////////////////////
// CMatrixNxM<TYPE>::InterchangeCols
//
// swaps two COLUMNS of the matrix
//////////////////////////////////////////////////////////////////////
template<class TYPE>
void CMatrixNxM<TYPE>::InterchangeCols(int nCol1, int nCol2)
{
	...
	//////////////////////////////////////////////////////////////////////
template<class TYPE>
int CMatrixNxM<TYPE>::FindPivotRow(int nDiag)
{
...
}	// CMatrixNxM<TYPE>::FindPivotRow


//////////////////////////////////////////////////////////////////////
// CMatrixNxM<TYPE>::FindPivotElem
//
// finds the pivot element, returning the row and column
//////////////////////////////////////////////////////////////////////
template<class TYPE>
void CMatrixNxM<TYPE>::FindPivotElem(int nDiag,
